...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 30, 2020 at 08:51 PM
...
(37, 'VOW', 250, 5, 'Novel', 15, 1, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc eu turpis imperdiet, maximus orci ut, accumsan diam. Phasellus cursus dignissim aliquam.', 'cover_cover24.jpg', 1, 1, 1),
...
(41, 28, 53, 200, 'PURE', 'cover_cover5.jpg'),
(42, 28, 48, 350, 'The secret of color', 'cover_cover4.jpg'),
...
INSERT INTO `orders` (`id`, `user_id`, `product_id`, `price`, `product_name`, `product_image`) VALUES
(40, 28, 55, 400, 'The house girl', 'cover_cover23.jpg'),
(41, 28, 56, 420, 'Crow moon', 'cover_cover26.jpg'),
(42, 29, 44, 300, 'No place like here', 'cover_cover2.jpg'),
(43, 29, 52, 200, 'Higher education', 'cover_cover8.jpg'),
(44, 29, 51, 150, 'The ultimate manual', 'cover_cover9.jpg'),
(45, 30, 50, 250, 'Chole Hoper', 'cover_cover7.jpg'),
(53, 33, 46, 400, 'Herry potter', 'cover_cover14.jpg'),
(54, 33, 39, 300, 'Extinction level', 'cover_cover25.jpg'),
(55, 33, 44, 300, 'No place like here', 'cover_cover2.jpg'),
(56, 33, 37, 350, 'VOW', 'cover_cover24.jpg'),
(57, 33, 49, 450, 'Harsh reality', 'cover_cover10.jpg'),
(58, 33, 51, 150, 'The ultimate manual', 'cover_cover9.jpg'),
(59, 33, 52, 200, 'Higher education', 'cover_cover8.jpg');
...
ALTER TABLE `orders`
  ...
  ADD CONSTRAINT `orders_ibfk_2` FOREIGN KEY (`product_id`) REFERENCES `books` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION;
COMMIT;
